...
class PyManMain:
    ...
    def __init__(self, width=792, height=600):
        ...
        self.player_1 = Player(self.screen, (255, 255, 0), self.grid.net[0][0].x * self.grid.size,
                          self.grid.net[0][0].y * self.grid.size,
                          self.grid.size - self.grid.margin

                          )

        self.player_2 = Player(self.screen, (255, 255, 0), self.grid.net[-1][-1].x * self.grid.size,
